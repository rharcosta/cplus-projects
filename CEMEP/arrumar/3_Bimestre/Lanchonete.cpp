...
if (a==1)
                 ...
                 printf("Que sabor de pastel deseja?\n");
                 scanf("%i",&b);
                 }
if (b==1)
...
if (b==5)
printf("Voce escolheu a opcao do pastel de sonho de valsa");    
...
if (a==2)
                 ...
                 printf("Como deseja que seu cachorro quente seja composto?\n");
                 scanf("%i",&c);
                 }
...
if (d==5)
printf("Voce escolheu a opcao da Porcao de Churros"); 
